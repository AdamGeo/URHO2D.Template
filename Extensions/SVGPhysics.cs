...
namespace URHO2D.Template
{
    ...
    public class SVGPhysics : Dictionary<string, dynamic>
    {
        public SVGPhysics()
        {
        }
        public SVGPhysics(string file)
        {
            LoadSVG(file);
        }
        ...
        private void ParseSVG(SVGPhysics dict, IEnumerable<XElement> elements, float w, float docSizeH)
        {
            ...
            for (int i = 0; i < elements.Count(); i++)
            {
                ...
                try
                {
                    ...
                    {
                        SVGPhysics plist = new SVGPhysics();
